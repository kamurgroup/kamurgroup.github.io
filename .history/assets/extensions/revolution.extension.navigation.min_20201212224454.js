...
!(function () {
  ...
  var i = function (t, e) {
          ...
          p > 2 && ((g = 0 >= c - (v + d) ? (0 - d > c - (v + d) ? v : g + d) : g), (g = d > c - d + v + l && c + (Math.round(p) - 2) * d < v ? c + (Math.round(p) - 2) * d : g)),
              ...
              t.hasClass("dragged") ||
                  ("vertical" === o ? s.data("tmmove", punchgs.TweenLite.to(s, 0.5, { top: g + "px", ease: punchgs.Power3.easeInOut })) : s.data("tmmove", punchgs.TweenLite.to(s, 0.5, { left: g + "px", ease: punchgs.Power3.easeInOut })),
                  s.data("offset", g));
      },
                  ...
                  swipeStatus: function (e, n, s, d) {
                      ...
                      if (
                          ...
                          switch (((a.dragStartedOverSlider = !0), (d = s && s.match(/left|up/g) ? Math.round(-1 * d) : (d = Math.round(1 * d))), n)) {
                              case "start":
                                  void 0 !== r.positionanim && (r.positionanim.kill(), (r.slide_globaloffset = "off" === r.infinity ? r.slide_offset : t.simp(r.slide_offset, r.maxwidth))),
                                      (r.overpull = "none"),
                              ...
                              case "move":
                                  if (((r.slide_offset = "off" === r.infinity ? r.slide_globaloffset + d : t.simp(r.slide_globaloffset + d, r.maxwidth)), "off" === r.infinity)) {
                                      ...
                                      ("none" !== r.overpull && 0 !== r.overpull) || !(0 > g || g > a.slideamount - 1)
                                          ? g >= 0 && g <= a.slideamount - 1 && ((g >= 0 && d > r.overpull) || (g <= a.slideamount - 1 && d < r.overpull)) && (r.overpull = 0)
                                          : (r.overpull = d),
                                          (r.slide_offset =
                                              0 > g
                                                  ? r.slide_offset + (r.overpull - d) / 1.1 + Math.sqrt(Math.abs((r.overpull - d) / 1.1))
                                                  : g > a.slideamount - 1
                                                  ? r.slide_offset + (r.overpull - d) / 1.1 - Math.sqrt(Math.abs((r.overpull - d) / 1.1))
                                                  : r.slide_offset);
                                  }
      ...
      m = function (t, e) {
          ...
          if (
              ...
              s > a && "outer-left" !== e.position && "outer-right" !== e.position
                  ...
                  : (punchgs.TweenLite.set(t, { maxWidth: s + "px" }), punchgs.TweenLite.set(d, { maxWidth: s + "px" })),
                  ...
                  e.span === !0 && "vertical" === e.direction
                      ? (punchgs.TweenLite.set(t, { maxHeight: l + h + (n - 2 * r) + "px", height: l + h + (n - 2 * r) + "px", top: 0 - l, y: 0 }), g(d, e))
                      : e.span === !0 && "horizontal" === e.direction && (punchgs.TweenLite.set(t, { maxWidth: "100%", width: a - 2 * r + "px", left: 0, x: 0 }), v(d, e));
          }
      },
      b = function (t, e, i, a) {
